...
#we also get the expected drive time and distance
...
#counties had the most/least startbucks stores? we could define the county boundaries as spatial polygons, set each
